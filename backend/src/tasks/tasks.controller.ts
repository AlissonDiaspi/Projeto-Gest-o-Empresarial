import {
  ...
  Get,
  Query,
  Delete,  // Adicionar Delete
  HttpCode, // Adicionar HttpCode
  HttpStatus, // Adicionar HttpStatus
} from '@nestjs/common';
...
export class TasksController {
  ...
  @Roles(
    Role.OWNER,
    Role.ADMIN,
    Role.MEMBER, // Membro pode deletar suas próprias tasks (verificado no service)
  )
  @Delete(':taskId')
  @HttpCode(HttpStatus.NO_CONTENT)
  async deleteTask( // endpoint para deletar uma task
    @Param('projectId')
    projectId: string,
...
async updateTask(
  ...
  return this.tasksService.updateTask(projectId, taskId, body, req.user.id);
}
}