...
export default function TeamsPage() { // pagina dos times de uma empresa
  ...
  const loadTeams = async () => { // para carregar os times de uma empresa
  ...
  const handleDelete = async () => { // para deletar o time de uma empresa
