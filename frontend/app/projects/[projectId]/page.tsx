        ...
        <main className="flex min-h-screen">
          ...
          <section className="flex-1 flex-col">
            ...
            <div className="text-center py-12">
              ...
              <Link href="/projects" className="text-blue-500 hover:underline">Voltar</Link>
            </div>
          </section>
        </main>
      </ProtectedRoute>
        ...
        <section className="flex-1 flex-col">
          ...
          <div className="p-8">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <Link href="/projects" className="text-sm text-muted-foreground hover:text-foreground mb-2 inline-flex items-center">
                  <ArrowLeft className="w-4 h-4 mr-1" /> Voltar
                </Link>
                <h1 className="text-3xl font-bold mt-2">{project.name}</h1>
                {project.description && <p className="text-muted-foreground mt-1">{project.description}</p>}
                {project.team && <p className="text-sm text-muted-foreground mt-1">Time: {project.team.name}</p>}
              </div>
